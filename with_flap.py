...
SERVO_1_CENTER = 99  # Nudged left by half a tooth (9 degrees) to fix right-tilt -- 20 splines
SWEEP_AMPLITUDE = 20 # How far it swings from center

SERVO_1_RIGHT = SERVO_1_CENTER - SWEEP_AMPLITUDE  
SERVO_1_LEFT = SERVO_1_CENTER + SWEEP_AMPLITUDE   
